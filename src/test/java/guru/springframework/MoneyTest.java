...
public class MoneyTest {
    ...
    void testEqualityFranc(){
        ...
        assertNotEquals(Money.franc(5), Money.franc(4));
    }
    ...
    @Test
    void testReduceMoneyDiffenceCurrency(){
        Bank bank = new Bank();
    ...
    void testMixAddition(){
        Expression fiveBucksMoney = Money.dollar(5);
        Expression tenFrancs = Money.franc(10);

        Bank bank = new Bank();
        bank.addRate("CHF", "USD", 2);
        Money result = bank.reduce(fiveBucksMoney.plus(tenFrancs), "USD");
